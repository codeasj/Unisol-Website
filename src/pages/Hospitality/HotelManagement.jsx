...
const HotelManagement = () => {
  ...
  return (
    <>
      <HospitalityBanner
        currentImage={currentCareerPage + 1}
      ...
      <div className="w-full relative mt-10 md:mt-0 ">
        ...
        <div className="md:pt-[76px] px-5 md:px-10  lg:pl-20 xl:pl-[138px] pr-[39px]">
          <div>
            ...
            <div className="flex mt-[44px] h-full gap-3 pb-20 lg:pb-[180px] xl:pb-[248px]  items-center">
      ...
      <div className="bg-[#243B53] flex justify-center">
        <img
          src="../assets/images/hotelBanner.png"
          alt="banner"
          className="aspect-[848/873]  md:h-[600px]"
        />
      </div>
